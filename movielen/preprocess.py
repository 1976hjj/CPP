...
df_rounded = transformation.round_timestamp(schema_record,48)
...
df_sorted.repartition(1344, df_sorted["content_id"]).write.csv("data_partitioned_2day_derivative_2", sep=";", header=True)
