...
df_all_content = df_all_content.sort_values(by=["counts_x","content_id"],ascending=False)
df_all_content["predict_rank"] = range(1,len(df_all_content)+1)

df_all_content = df_all_content.sort_values(by=["counts_y","content_id"],ascending=False)
df_all_content["historic_rank"] = range(1,len(df_all_content)+1)

df_all_content = df_all_content.sort_values(by=["counter","content_id"],ascending=False)
